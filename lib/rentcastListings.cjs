...
const EASTSIDE_CITY_GROUPS = {
  ...
  Renton: ["Renton", "Bellevue", "Newcastle", "Tukwila", "Kent"],
};
...
function isEastsideTarget(destination = UW_DESTINATION) {
  return Object.prototype.hasOwnProperty.call(EASTSIDE_CITY_GROUPS, destination.city);
}
